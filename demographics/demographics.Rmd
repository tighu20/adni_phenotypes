...
ukbb_data_summary <- ukbb_data %>%
  ...
  summarise(n = length(eid),
            ...
            sex = paste(round((length(sex[sex=="0"]) / n()) * 100, digits = 2),
                        round((length(sex[sex =="1"]) / n()) * 100, digits = 2),
                        sep = "/"),
            hand = paste(round((length(hand[hand == 1]) / n()) * 100, digits = 2),
                               round((length(hand[hand == 2]) / n()) * 100, digits = 2),
                               round((length(hand[hand == 3]) / n()) * 100, digits = 2),
                               sep = "/"),
            .groups = "keep")
