...
p <- ggplot(df_blank, aes(x = x, y = y)) + geom_point() + xlim(0, 1.) + ylim(c * 1.2, a * 1.2) +
...
```{r}
p_clinscore <- ggplot(naccmoca, aes(x = mean, y = naccmoca, group = adlike, colour = adlike))
p_clinscore <- p_clinscore + geom_point() + geom_smooth(method = lm)
print(p_clinscore)
```
...
```{r}
p_clinscore <- ggplot(digif, aes(x = mean, y = digif, group = diagnosis, colour = diagnosis))
p_clinscore <- p_clinscore + geom_point() + geom_smooth(method = lm)
print(p_clinscore)
```
...
```{r}
p_clinscore <- ggplot(digib, aes(x = mean, y = digib, group = diagnosis, colour = diagnosis))
p_clinscore <- p_clinscore + geom_point() + geom_smooth(method = lm)
print(p_clinscore)
```
...
```{r}
p_clinscore <- ggplot(animals, aes(x = mean, y = animals, group = diagnosis, colour = diagnosis))
p_clinscore <- p_clinscore + geom_point() + geom_smooth(method = lm)
print(p_clinscore)
```
...
```{r}
p_clinscore <- ggplot(trialsb, aes(x = mean, y = trialsb, group = diagnosis, colour = diagnosis))
p_clinscore <- p_clinscore + geom_point() + geom_smooth(method = lm)
print(p_clinscore)
```
...
df_blank = data.frame(x = c(-.5), y = c(0))
p <- ggplot(df_blank, aes(x = x, y = y)) + geom_point() + xlim(0, 1.) + ylim(a * 1.2, c * 1.2) +
  geom_segment(x = 0, y = a,
               xend = d, yend = b) +
  geom_segment(x = d, y = b,
               xend = 1., yend = c) +
