...
# # z-score mean
# age_mean = mean(naccmmse$age, na.rm = TRUE)
# age_sd = sd(naccmmse$age, na.rm = TRUE)
...
```{r}
# set priors
mmse_priors = c(set_prior("normal(0,10)", class = "b", coef = "age"),
                set_prior("cauchy(0,1)", class = "b", coef = "diagnosisAD"),
                set_prior("cauchy(0,1)", class = "b", coef = "diagnosisOD"),
                set_prior("cauchy(0,1)", class = "b", coef = "diagnosisOND"),
                set_prior("cauchy(0,1)", class = "b", coef = "mean"),
                set_prior("cauchy(0,1)", class = "b", coef = "mean:diagnosisAD"),
                set_prior("cauchy(0,1)", class = "b", coef = "mean:diagnosisOD"),
                set_prior("cauchy(0,1)", class = "b", coef = "mean:diagnosisOND"))

fit_mmse <- brm(nacmmse | trunc(ub = 30, lb = 0) ~ mean * diagnosis + age,
                data = naccmmse,
                prior = mmse_priors,
                family = "skew_normal",
                iter = 5000,
