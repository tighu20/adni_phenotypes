...
```{r}
p_clinscore <- ggplot(wais, aes(x = mean, y = wais, group = diagnosis, colour = diagnosis))
p_clinscore <- p_clinscore + geom_point() + geom_smooth(method = lm)
print(p_clinscore)
```
...
```{r}
p_clinscore <- ggplot(boston, aes(x = mean, y = boston, group = diagnosis, colour = diagnosis))
p_clinscore <- p_clinscore + geom_point() + geom_smooth(method = lm)
print(p_clinscore)
```